...
// radT samples resource metrics over wall-clock time, often at step 0 only, so
// line charts stay the useful seed where upstream would fall back to bars.
const MIN_NUMBER_OF_STEP_FOR_LINE_COMPARISON = 0;
